    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String rat = ratting.getText().toString();
                if(!(name.isEmpty() || rat.isEmpty() || Disc.isEmpty() || Location.isEmpty() || phone1.isEmpty()))
                {
                    SharedPreferences sp = getSharedPreferences("Hottel3", Context.MODE_PRIVATE);
                    ...
                    if(!size.isEmpty())
                    {
                        ...
                        if(!b1)
                        {
                            ...
                            resultIntent.putExtra("position", size1 - 1); // Passing the position of the newly added item
